...
$("a").click(function( e ) {
    ...
    $('.owl-carousel-header').owlCarousel({
      ...
      margin:10,
      nav:true,
      navText : ['<img src="../assets/images/home/arrowOwlH2.svg" />','<img src="../assets/images/home/arrowOwlH1.svg" />'],
      responsive:{
          0:{
              items:1
          },
  ...
  $('.owl-carousel-center').owlCarousel({
    ...
    margin:35,
    nav:true,
    navText : ['<img src="../assets/images/home/arrowSlider2.svg" />','<img src="../assets/images/home/arrowSlider1.svg" />'],
    rtl: true,
    stagePadding: 38,
...
$('.owl-carousel-event2').owlCarousel({
    ...
    rtl: true,
    nav:true,
    navText : ['<img src="../assets/images/home/arrowSlider1.svg" />','<img src="../assets/images/home/arrowSlider2.svg" />'],
    // items:3.5,
    responsive:{
        0:{
            items:1
